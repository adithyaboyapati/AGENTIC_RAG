> **Historical archive snapshot** — point-in-time milestone from pre-canonical era. Current docs: [../DOCUMENTATION_MAP.md](../DOCUMENTATION_MAP.md) · [../GUARDRAILS.md](../GUARDRAILS.md)
